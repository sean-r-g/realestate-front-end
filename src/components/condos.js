...
const handleNewCondoSubmit = (event) =>{
  ...
  axios.post('https://real-estate-back-end/condos', {
    name: newName,
    ...
    axios.get('https://real-estate-back-end/condos').then((response)=>{
...
const handleCondoUpdateSubmit = (event, condoData) =>{
  event.preventDefault()
  axios.put(`https://real-estate-back-end/condos/${condoData._id}`, {
    name: newName,
    location: newlocation,
    price: newPrice,
    size: newSize,
...
const handleCondoDelete = (condoData) =>{
  axios.delete(`https://real-estate-back-end/condos/${condoData._id}`).then(()=>{
    axios.get('https://real-estate-back-end/condos').then((response)=>{
      setCondos(response.data)
    })
  })
